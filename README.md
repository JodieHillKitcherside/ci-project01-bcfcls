...
![amiresponsive.co.uk](assets/images/screenshots-readme/amiresponsive-final.jpg)
...
![BCFCLS Nav Bar](assets/images/screenshots-readme/gallery-wireframe.png)
...
# MR finds to consider
  ...
  ![iPadMini Team Mentions](assets/images/screenshots-readme/ipadmini-team.jpg)
    # iPad Mini View - Social Twitter
...
## Wave
  ...
  - Examples of alerts:
    - Gallery - images and videos miss caption - would add captions for all media on gallery page with feedback per upload from the bcfcls team, features to add.
